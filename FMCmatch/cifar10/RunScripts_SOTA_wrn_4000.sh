...
--dropout 0.0 --DA "jitter" --experiment_name "W_SOTA_CIFAR10" --download "True" --network "WRN28_2_wn"
...
# SSL training
python3 train.py --labeled_samples 4000 --labeled_batch_size 16 --swa "False" --lr 0.1 --epoch 280 --M 250 --initial_epoch 30 \
--dropout 0.0 --DA "jitter" --experiment_name "W_SOTA_CIFAR10" --download "True" --network "WRN28_2_wn"

# SSL training
python3 train.py --labeled_samples 4000 --labeled_batch_size 16 --swa "True" --lr 0.001 --epoch 50 --initial_epoch 280 \
--dropout 0.0 --DA "jitter" --experiment_name "W_SOTA_CIFAR10" --download "True" --network "WRN28_2_wn"
