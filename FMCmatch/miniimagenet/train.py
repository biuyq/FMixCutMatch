...
def parse_args():
    ...
    parser.add_argument('--test_batch_size', type=int, default=200, help='Number of images in each mini-batch')
    ...
    parser.add_argument('--train_root', default='./data/miniImagenet', help='Root for train data')
    parser.add_argument('--labeled_samples', type=int, default=10000, help='Number of labeled samples')
    parser.add_argument('--alpha', type=float, default=0.4, help='Hyperparam for loss')
    parser.add_argument('--beta', type=float, default=0.4, help='Hyperparam for loss')
